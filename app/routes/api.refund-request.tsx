...
export async function loader({ request }: LoaderFunctionArgs) {
    ...
    return { shop, customerId, orderId, orderName };
}
...
export default function RefundRequestPage() {
    const { shop, customerId, orderId, orderName } = useLoaderData<typeof loader>();
            ...
            <div style={pageWrapper}>
                <div style={card}>
                    <div style={successBox}>
                        ...
                        <h2 style={{ fontWeight: 700, fontSize: "20px", margin: "12px 0 8px" }}>
                            Request Submitted!
                        </h2>
...
const successBox: React.CSSProperties = { textAlign: "center", padding: "20px 0" };